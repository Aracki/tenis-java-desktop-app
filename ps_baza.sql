...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2015 at 01:59 AM
...
(2, 'ogi', 'adamovic', 'ko', 'ko', 0, 0, -1, 0, 16, -15, -1, -1, 1, 121),
...
(12, 'Ogi232', '2015-07-06', 66),
(13, 'vozilo213', '2015-07-04', 65),
(14, 'sustinaVozila34', '2015-07-02', 67),
(15, '44stuzikasd', '2015-07-04', 65),
(16, 'sdaoin', '2015-07-04', 65),
(17, 'daf', '2015-07-04', 64),
(18, 'saddas', '2015-07-04', 65),
(19, 'sdadas', '2015-07-04', 67),
(20, 'takmicenjeBeograd', '2015-07-08', 64),
(21, 'GGG', '2015-07-06', 65),
(22, 'DDD', '2015-07-06', 65);
...
--
ALTER TABLE `liga`
  ADD CONSTRAINT `liga_ibfk_1` FOREIGN KEY (`takmicenje`) REFERENCES `takmicenje` (`takmicenjeID`) ON DELETE CASCADE;
...
ALTER TABLE `takmicar`
  ADD CONSTRAINT `takmicar_ibfk_1` FOREIGN KEY (`liga`) REFERENCES `liga` (`ligaID`),
  ADD CONSTRAINT `takmicar_ibfk_2` FOREIGN KEY (`mesto`) REFERENCES `mesto` (`ptt`) ON UPDATE CASCADE;

--
-- Constraints for table `takmicenje`
--
ALTER TABLE `takmicenje`
  ADD CONSTRAINT `takmicenje_ibfk_1` FOREIGN KEY (`tiptakmicenja`) REFERENCES `tiptakmicenja` (`tiptakmicenjaID`);
